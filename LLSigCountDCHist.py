...
from TreeVarSel_LL import TreeVarSel
from HistInfo import HistInfo
from MCWeight import MCWeight
from Binning_LL import *
from GenFilterEff import GenFilterEff
from XsecUnc import *
from TrigEff import *
from FullFastSF import FullFastSF
from VarCalc import Get_ctau_sample as Get_ctau
from LLStopsSampleChain import SampleChain
from FileList_LLStops2016PreVFP import samples as samples_2016Pre
from FileList_LLStops2016PostVFP import samples as samples_2016Post
from FileList_LLStops2017 import samples as samples_2017
from FileList_LLStops2018 import samples as samples_2018
...
if 'stopLL' in samples:
    histext = samples
    sample = samples
    print('running over: ', sample, '  for branching fraction: ', BR)
    ...
    hfile = ROOT.TFile('LLSigCountDCHist_'+region+'_'+BR+'_'+str(sigid)+'.root', 'RECREATE')
    histos = {}
    ...
    ch03, ch10 = SampleChain(sample, 0, 1, year).getchains()
    ...
    for ientry in range(n_entries03):
        ...
        if math.isclose(ientry % (nevtcut/10), 0, abs_tol=1e-9) or math.isclose(ientry % (nevtcut/10), nevtcut/10, abs_tol=9e-1):
            print('processing ', ientry,'th event')
